...
class _VenueDetailScreenState extends State<VenueDetailScreen> {
  ...
  final albums = [
    {
      "image": "assets/venueDetail/album1.png",
      "title": "Main hall",
      "Noimage": 150
    },
    {
      "image": "assets/venueDetail/album2.png",
      "title": "Dining area",
      "Noimage": 20
    },
    {
      "image": "assets/venueDetail/album3.png",
      "title": "Dj party",
      "Noimage": 20
    },
    {
      "image": "assets/venueDetail/album4.png",
      "title": "Garden",
      "Noimage": 30
    },
  ];
  ...
  final similar = [
    {
      "image": "assets/venueDetail/sp1.png",
      "title": "Gallery Metro",
      "price": 56
    },
    {
      "image": "assets/venueDetail/sp2.png",
      "title": "Sunset View Wedding",
      "price": 56
    },
    {
      "image": "assets/venueDetail/sp3.png",
      "title": "Serenity Grove",
      "price": 56
    },
    {
      "image": "assets/venueDetail/sp4.png",
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      ...
                      content: Text(
                        isFavorite
                            ? getTranslate(
                                context, 'venue_detail.add_shortlist')
                            : getTranslate(
                                context, 'venue_detail.remove_shortlist'),
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          "150 ${getTranslate(context, 'venue_detail.image')}",
  ...
  bottomButton(Size size) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          getTranslate(context, 'venue_detail.check_availability'),
          style: bold18White,
        ),
      ),
    );
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(
                getTranslate(context, 'venue_detail.review'),
              ...
              InkWell(
                ...
                child: Text(
                  getTranslate(context, 'venue_detail.view_all'),
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: fixPadding * 2),
          child: Text(
            getTranslate(context, 'venue_detail.similar_venue'),
            style: semibold16black2,
          ),
        ),
        SizedBox(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "\$${similar[index]['price']} ${getTranslate(context, 'venue_detail.onward')}",
                            style: semibold13Primary,
                          )
                        ],
                      ),
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                getTranslate(context, 'venue_detail.albums'),
                style: semibold16black2,
              ),
              InkWell(
                onTap: () {
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${albums[index]['Noimage']} ${getTranslate(context, 'venue_detail.image')}",
  ...
  areaAvailableOption(Size size) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslate(context, 'venue_detail.areas_available'),
            style: semibold16black2,
          ),
          heightSpace,
          Row(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            FittedBox(
                              child: Text(
                                getTranslate(context, 'venue_detail.outdoor'),
                                style: semibold13black2,
                              ),
                            ),
                            height5Space,
                            FittedBox(
                              child: Text(
                                "250 ${getTranslate(context, 'venue_detail.seats')}",
                                style: semibold13Grey,
                              ),
                            )
                          ],
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            FittedBox(
                              child: Text(
                                getTranslate(context, 'venue_detail.indoor'),
                                style: semibold13black2,
                              ),
                            ),
                            height5Space,
                            FittedBox(
                              child: Text(
                                "300 ${getTranslate(context, 'venue_detail.seats')}",
                                style: semibold13Grey,
                              ),
                            )
                          ],
  ...
  paymentDetail() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslate(context, 'venue_detail.payment'),
            style: semibold16black2,
          ),
          heightSpace,
          Text(
            "\$56 ${getTranslate(context, 'venue_detail.onwards')}",
            style: semibold16Primary,
          ),
          Text(
            "(${getTranslate(context, 'venue_detail.advance_payment')}\$20)",
  ...
  aboutText() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            getTranslate(context, 'venue_detail.about'),
            style: semibold16black2,
          ),
          heightSpace,
          ReadMoreText(
            ...
            trimExpandedText: getTranslate(context, 'venue_detail.show_less'),
            trimCollapsedText: getTranslate(context, 'venue_detail.read_more'),
          )
        ],
      ),
    );
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        width5Space,
                        Text(
                          "250 ${getTranslate(context, 'venue_detail.guest')}",
                          style: medium13black2,
                        )
                      ],
                    ),
